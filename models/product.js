...
const productSchema = mongoose.Schema({
  ...
  category: {
    ...
    required: [
      true,
      "please provide a category from long-sleeves,short-sleeves,sweat-shirts,hoodies",
    ],
    enum: {
      values: ["longsleeves", "shortsleeves", "sweatshirts", "hoodies"],
    },
    message:
      "please select category from longsleeves,shortsleeves,sweatshirts,hoodies",
  },
  stock: {
    type: Number,
